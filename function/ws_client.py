...
class Intent:
    ...
    GROUP_AND_C2C = 1 << 25  # 群和C2C事件(含GROUP_AT_MESSAGE_CREATE, GROUP_MESSAGE_CREATE, C2C等)
    INTERACTION = 1 << 26
    MESSAGE_AUDIT = 1 << 27
    # FORUM = 1 << 28
    # AUDIO = 1 << 29
...
_DEFAULT_INTENTS = Intent.PUBLIC_GUILD_MESSAGES | Intent.DIRECT_MESSAGE | Intent.GROUP_AND_C2C | Intent.INTERACTION
